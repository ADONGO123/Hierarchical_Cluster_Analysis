...
We represent the results of the agglomerative clustering using the single linkage method by extracting the merging stages and corresponding distances from the `cluster_agg_average` object. Specifically, we combine the `merge` matrix and the `height` vector into a single data frame.
